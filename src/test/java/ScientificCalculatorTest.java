...
public class ScientificCalculatorTest {
    ...
    public void testSquareRoot() {
        ...
        assertEquals(5.0, sc.squareRoot(25),0.0f);
        assertEquals(6.0, sc.squareRoot(36),0.0f);
    }

    @Test
    public void testFactorial() {
        assertEquals(1, sc.factorial(0),0.0f);
        assertEquals(1, sc.factorial(1),0.0f);
        assertEquals(6, sc.factorial(3),0.0f);
        assertEquals(24, sc.factorial(4),0.0f);
    ...
    public void testNaturalLogarithm() {
        ...
        assertEquals(0.6931, sc.naturalLogarithm(2),0.2f);
        assertEquals(1.3862, sc.naturalLogarithm(4),0.2f);
    ...
    public void testPower() {
        ...
        assertEquals(8.0, sc.power(2, 3),0.0f);
        assertEquals(9.0, sc.power(3, 2),0.0f);
        assertEquals(81.0, sc.power(3, 4),0.0f);
